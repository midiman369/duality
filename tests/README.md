...
| `replay_harmony.py` | Harmony balance (`SONG=03/07/97`): ghost and hero velocity scales, no upper ghost left over a line that starts above it, harmony count kept; 97 also checks the ch3 string solo is found as a featured line and lifted |
